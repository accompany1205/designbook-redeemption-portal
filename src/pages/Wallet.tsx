        ...
        <div className="flex items-center justify-center min-h-screen">
          {!activeNft ? (
            <div>
              ...
              <div className="bg-[#F5F5F5] rounded-[25px] minW-[300px] pt-4 pb-8">
                ...
                <div className="bg-[#f0e4fe] text-sm font-medium text-center text-[#696969] mb-4 py-2">
                  {userMetadata?.email}
                </div>
            ...
            <>
              {!sentModalShow ? (
                <div className="w-[384px] max-w-[calc(100%-20px)] pt-4 bg-white rounded-[25px] shadow-2xl">
                ...
                <div className="w-[384px] max-w-[calc(100%-20px)] p-6 bg-white rounded-[25px] shadow-2xl">
    ...
    <section className="bg-[#F0E4FE]">
      <div className="flex items-center justify-center h-screen">
        <div>
          ...
          <div className="bg-[#F5F5F5] min-w-[270px] rounded-[25px] minW-[300px] pt-4 pb-8">
            <div className="flex items-center justify-between px-4 mb-6">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="23"

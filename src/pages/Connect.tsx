  ...
  return (
    <section className="bg-[#F0E4FE]">
      <div className="flex items-center justify-center h-screen">
        <div className="rounded-[25px] bg-white py-4 md:py-12 px-8 md:px-16">
          <div className="text-center text:xl  md:text-2xl font-medium mb-2 md:mb-4">
            Log in <span className="text-[#5E1DFC] font-bold">to wallet</span>
          </div>
          <div className="text-center text:xl  md:text-md font-normal mb-2 md:mb-4">
            Sign in to{" "}
          ...
          <div className="flex justify-center mt-2 md:mt-4 text-[#696969] font-normal text-sm">
            OR
          </div>
          ...
          <div className="text-center mt-2 md:mt-4 text-sm font-normal text-[#0F91D2] cursor-pointer">
            Open the Hashpack extension
          </div>
          <div className="text-center mt-4 md:mt-8 text-sm font-normal text-[#696969]">
            Privacy - Terms
          </div>
          <div className="text-center mt-2 md:mt-4 text-xs font-normal text-[#959595]">
